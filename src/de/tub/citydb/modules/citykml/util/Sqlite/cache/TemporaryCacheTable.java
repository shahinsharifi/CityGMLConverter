...
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableBasic;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableDeprecatedMaterial;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableGlobalAppearance;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableGmlId;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableGroupToCityObject;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableLibraryObject;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableLinearRing;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableModel;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableModelEnum;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableSurfaceGeometry;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableTextureAssociation;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableTextureFile;
import de.tub.citydb.modules.citykml.util.Sqlite.cache.model.CacheTableTextureParam;
...
public class TemporaryCacheTable implements CacheTable {
	...
	protected TemporaryCacheTable(CacheTableModelEnum model, Connection dbPool, boolean isStandAlone) {
