...
public class DBWaterBoundarySurface implements Importer {
	...
	public DBWaterBoundarySurface(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {		
		...
		bodyToSurfaceImporter = (DBWaterBodToWaterBndSrf)dbImporterManager.getDBImporter(ImporterEnum.WATERBOD_TO_WATERBND_SRF);
	}
	...
	public long insert(AbstractWaterBoundarySurface waterBoundarySurface, long parentId) throws SQLException {
        ...
        if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.WATERBOUNDARY_SURFACE);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.WATERBOUNDARY_SURFACE;
	}
