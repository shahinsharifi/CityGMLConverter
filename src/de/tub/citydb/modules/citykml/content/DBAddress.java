...
public class DBAddress implements Importer {	
	...
	public DBAddress(Connection batchConn, Config config, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {
		...
		addressToBuildingImporter = (DBAddressToBuilding)dbImporterManager.getDBImporter(ImporterEnum.ADDRESS_TO_BUILDING);
	...
	public long insert(Address address) throws SQLException {
		...
		if (success) {		
			...
			if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
				dbImporterManager.executeBatch(ImporterEnum.ADDRESS);
