...
public class DBDeprecatedMaterialModel implements Importer {
	...
	public DBDeprecatedMaterialModel(Config config, ImporterManager dbImporterManager) throws SQLException {
		this.config = config;
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.DEPRECATED_MATERIAL_MODEL;
	}
