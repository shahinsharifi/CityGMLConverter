...
public class DBBuildingFurniture implements Importer {
	...
	public DBBuildingFurniture(Connection batchConn, Config config, ImporterManager dbImporterManager) throws SQLException {
	...
	public long insert(BuildingFurniture buildingFurniture, long roomId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.BUILDING_FURNITURE);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.BUILDING_FURNITURE;
	}
