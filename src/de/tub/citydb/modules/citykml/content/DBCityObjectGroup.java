...
public class DBCityObjectGroup implements Importer {
	...
	public DBCityObjectGroup(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private boolean insert(CityObjectGroup cityObjectGroup, long cityObjectGroupId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.CITYOBJECTGROUP);		
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.CITYOBJECTGROUP;
	}
