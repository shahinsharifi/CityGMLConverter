...
import de.tub.citydb.modules.citykml.content.*;
import de.tub.citydb.modules.citykml.content.CityObject;
import de.tub.citydb.modules.citykml.content.DBAddress;
import de.tub.citydb.modules.citykml.content.DBAddressToBuilding;
import de.tub.citydb.modules.citykml.content.DBAppearToSurfaceData;
import de.tub.citydb.modules.citykml.content.DBAppearance;
import de.tub.citydb.modules.citykml.content.DBBuildingFurniture;
...
import de.tub.citydb.modules.citykml.content.DBCityObjectGenericAttrib;
import de.tub.citydb.modules.citykml.content.DBCityObjectGroup;
import de.tub.citydb.modules.citykml.content.DBDeprecatedMaterialModel;
import de.tub.citydb.modules.citykml.content.DBExternalReference;
import de.tub.citydb.modules.citykml.content.DBGenericCityObject;
import de.tub.citydb.modules.citykml.content.DBImplicitGeometry;
import de.tub.citydb.modules.citykml.content.DBLandUse;
import de.tub.citydb.modules.citykml.content.DBOpening;
import de.tub.citydb.modules.citykml.content.DBPlantCover;
import de.tub.citydb.modules.citykml.content.DBReliefComponent;
import de.tub.citydb.modules.citykml.content.DBReliefFeatToRelComp;
import de.tub.citydb.modules.citykml.content.DBReliefFeature;
import de.tub.citydb.modules.citykml.content.DBRoom;
import de.tub.citydb.modules.citykml.content.DBSequencer;
...
import de.tub.citydb.modules.citykml.content.DBTrafficArea;
import de.tub.citydb.modules.citykml.content.DBTransportationComplex;
import de.tub.citydb.modules.citykml.content.DBWaterBodToWaterBndSrf;
import de.tub.citydb.modules.citykml.content.DBWaterBody;
import de.tub.citydb.modules.citykml.content.DBWaterBoundarySurface;
...
import de.tub.citydb.modules.citykml.content.OpeningToThemSurface;
import de.tub.citydb.modules.citykml.content.StGeometry;
import de.tub.citydb.modules.citykml.content.SurfaceData;
...
public class ImporterManager {
	...
	private final HashMap<ImporterEnum, Importer> dbImporterMap;
	...
	public ImporterManager(Connection batchConn,
		...
		dbImporterMap = new HashMap<ImporterEnum, Importer>();
	...
	public Importer getDBImporter(ImporterEnum dbImporterType) throws SQLException {
		Importer dbImporter = dbImporterMap.get(dbImporterType);
		...
		if (dbImporter == null) {
			...
			case SURFACE_GEOMETRY:
				dbImporter = new SurfaceGeometry(batchConn, config, this);
				break;
			case IMPLICIT_GEOMETRY:
				dbImporter = new DBImplicitGeometry(batchConn, config, this);
				break;
			case CITYOBJECT:
				dbImporter = new CityObject(batchConn, config, this);
				break;
			...
			case THEMATIC_SURFACE:
				dbImporter = new ThematicSurface(batchConn, this);
				break;
			case OPENING:
				dbImporter = new DBOpening(batchConn, this);
				break;
			case OPENING_TO_THEM_SURFACE:
				dbImporter = new OpeningToThemSurface(batchConn, this);
				break;
			case ADDRESS:
			...
			case APPEARANCE:
				...
				break;
			case SURFACE_DATA:
				dbImporter = new SurfaceData(batchConn, config, this);
				break;
			...
			case CITYOBJECTGROUP:
				...
				break;
			case ST_GEOMETRY:
				dbImporter = new StGeometry(config, this);
				break;
			}
	...
	public void executeBatch(ImporterEnum type) throws SQLException {
		for (ImporterEnum key : ImporterEnum.getExecutionPlan(type)) {
			Importer importer = dbImporterMap.get(key);
			if (importer != null)
	...
	public void executeBatch() throws SQLException {
		for (ImporterEnum key : ImporterEnum.EXECUTION_PLAN) {
			Importer importer = dbImporterMap.get(key);
			if (importer != null)
				importer.executeBatch();
		}
	...
	public void close() throws SQLException {
		...
		for (Importer importer : dbImporterMap.values())
			importer.close();
	}
}
