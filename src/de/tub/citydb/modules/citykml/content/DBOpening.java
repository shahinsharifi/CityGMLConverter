...
public class DBOpening implements Importer {
	...
	private OpeningToThemSurface openingToThemSurfaceImporter;
	private DBAddress addressImporter;
	
	private int batchCounter;
	
	public DBOpening(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {		
		...
		openingToThemSurfaceImporter = (OpeningToThemSurface)dbImporterManager.getDBImporter(ImporterEnum.OPENING_TO_THEM_SURFACE);
		addressImporter = (DBAddress)dbImporterManager.getDBImporter(ImporterEnum.ADDRESS);
	}
	...
	public long insert(AbstractOpening opening, long parentId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.OPENING);
