...
public class DBReliefFeature implements Importer {
	...
	public DBReliefFeature(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {
		...
		reliefComponentImporter = (DBReliefComponent)dbImporterManager.getDBImporter(ImporterEnum.RELIEF_COMPONENT);
	}
	...
	private boolean insert(ReliefFeature reliefFeature, long reliefFeatureId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.RELIEF_FEATURE);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.RELIEF_FEATURE;
	}
