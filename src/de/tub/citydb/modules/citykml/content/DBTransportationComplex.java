...
public class DBTransportationComplex implements Importer {
	...
	public DBTransportationComplex(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {		
		...
		trafficAreaImporter = (DBTrafficArea)dbImporterManager.getDBImporter(ImporterEnum.TRAFFIC_AREA);
	...
	private boolean insert(TransportationComplex transComplex, long transComplexId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.TRANSPORTATION_COMPLEX);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.TRANSPORTATION_COMPLEX;
	}
