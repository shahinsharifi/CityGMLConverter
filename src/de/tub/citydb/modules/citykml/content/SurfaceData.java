...
public class SurfaceData implements Importer {
	...
	public SurfaceData(Connection batchConn, Config config, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {
		...
		dbAppearToSurfaceDataImporter = (DBAppearToSurfaceData)dbImporterManager.getDBImporter(ImporterEnum.APPEAR_TO_SURFACE_DATA);
	}
	...
	public long insert(AbstractSurfaceData abstractSurfData, long parentId) throws SQLException {
		...
		if (abstractSurfData.getCityGMLClass() == CityGMLClass.X3D_MATERIAL) {
			...
			if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
				dbImporterManager.executeBatch(ImporterEnum.SURFACE_DATA);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.SURFACE_DATA;
	}
