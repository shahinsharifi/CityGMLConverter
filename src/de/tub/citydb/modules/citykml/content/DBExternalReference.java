...
public class DBExternalReference implements Importer {
	...
	public DBExternalReference(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	public void insert(ExternalReference externalReference, long cityObjectId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.EXTERNAL_REFERENCE);
	}
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.EXTERNAL_REFERENCE;
	}
