...
public class CityObject implements Importer {
	...
	public CityObject(Connection batchConn, Config config, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {
		...
		externalReferenceImporter = (DBExternalReference)dbImporterManager.getDBImporter(ImporterEnum.EXTERNAL_REFERENCE);
		appearanceImporter = (DBAppearance)dbImporterManager.getDBImporter(ImporterEnum.APPEARANCE);
	...
	public long insert(AbstractCityObject cityObject, long cityObjectId, boolean isTopLevelFeature) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.CITYOBJECT);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.CITYOBJECT;
	}
}
