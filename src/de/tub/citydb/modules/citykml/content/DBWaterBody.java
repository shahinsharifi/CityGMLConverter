...
public class DBWaterBody implements Importer {
	...
	public DBWaterBody(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {		
		...
		boundarySurfaceImporter = (DBWaterBoundarySurface)dbImporterManager.getDBImporter(ImporterEnum.WATERBOUNDARY_SURFACE);
	...
	private boolean insert(WaterBody waterBody, long waterBodyId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.WATERBODY);
