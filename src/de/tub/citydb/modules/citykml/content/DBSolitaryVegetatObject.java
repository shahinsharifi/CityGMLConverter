...
public class DBSolitaryVegetatObject implements Importer {
	...
	public DBSolitaryVegetatObject(Connection batchConn, Config config, ImporterManager dbImporterManager) throws SQLException {
	...
	private boolean insert(SolitaryVegetationObject solVegObject, long solVegObjectId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.SOLITARY_VEGETAT_OBJECT);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.SOLITARY_VEGETAT_OBJECT;
	}
