...
public class DBPlantCover implements Importer {
	...
	public DBPlantCover(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private boolean insert(PlantCover plantCover, long plantCoverId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.PLANT_COVER);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.PLANT_COVER;
	}
