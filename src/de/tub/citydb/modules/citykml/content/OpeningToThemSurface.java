...
public class OpeningToThemSurface implements Importer {
	...
	public OpeningToThemSurface(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	public void insert(long openingId, long thematicSurfaceId) throws SQLException {
        ...
        if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.OPENING_TO_THEM_SURFACE);
	}
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.OPENING_TO_THEM_SURFACE;
	}
