...
public class DBCityObjectGenericAttrib implements Importer {
	...
	public DBCityObjectGenericAttrib(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	public void insert(AbstractGenericAttribute genericAttribute, long cityObjectId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.CITYOBJECT_GENERICATTRIB);
	}
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.CITYOBJECT_GENERICATTRIB;
	}
