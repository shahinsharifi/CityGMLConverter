...
public class DBBuildingInstallation implements Importer {
	...
	public DBBuildingInstallation(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	public long insert(BuildingInstallation buildingInstallation, CityGMLClass parent, long parentId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.BUILDING_INSTALLATION);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.BUILDING_INSTALLATION;
	}
