...
public class DBAppearToSurfaceData implements Importer {
	...
	public DBAppearToSurfaceData(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	public void insert(long surfaceDataId, long appearanceId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.APPEAR_TO_SURFACE_DATA);
	}
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.APPEAR_TO_SURFACE_DATA;
	}
