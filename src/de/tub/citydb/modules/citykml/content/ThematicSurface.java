...
public class ThematicSurface implements Importer {
	...
	public ThematicSurface(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {		
		...
		openingImporter = (DBOpening)dbImporterManager.getDBImporter(ImporterEnum.OPENING);
	}
	...
	public long insert(AbstractBoundarySurface boundarySurface, CityGMLClass parent, long parentId) throws SQLException {
        ...
        if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.THEMATIC_SURFACE);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.THEMATIC_SURFACE;
	}
