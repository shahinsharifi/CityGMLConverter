...
public class DBLandUse implements Importer {
	...
	public DBLandUse(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private boolean insert(LandUse landUse, long landUseId) throws SQLException {
        ...
        if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.LAND_USE);
