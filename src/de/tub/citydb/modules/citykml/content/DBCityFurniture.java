...
public class DBCityFurniture implements Importer {
	...
	public DBCityFurniture(Connection batchConn, Config config, ImporterManager dbImporterManager) throws SQLException {
	...
	private boolean insert(CityFurniture cityFurniture, long cityFurnitureId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.CITY_FURNITURE);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.CITY_FURNITURE;
	}
