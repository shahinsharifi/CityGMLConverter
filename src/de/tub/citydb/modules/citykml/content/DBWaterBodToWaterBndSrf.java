...
public class DBWaterBodToWaterBndSrf implements Importer {
	...
	public DBWaterBodToWaterBndSrf(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	public void insert(long waterSurfaceId, long waterBodyId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.WATERBOD_TO_WATERBND_SRF);
	}
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.WATERBOD_TO_WATERBND_SRF;
	}
}
