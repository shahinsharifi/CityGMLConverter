...
public class DBTrafficArea implements Importer {
	...
	public DBTrafficArea(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	public long insert(TrafficArea trafficArea, long parentId) throws SQLException {
        ...
        if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.TRAFFIC_AREA);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.TRAFFIC_AREA;
	}
