...
public class DBReliefComponent implements Importer {
	...
	public DBReliefComponent(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {
		...
		reliefFeatToRelComp = (DBReliefFeatToRelComp)dbImporterManager.getDBImporter(ImporterEnum.RELIEF_FEAT_TO_REL_COMP);
	...
	public long insert(AbstractReliefComponent reliefComponent, long parentId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.RELIEF_COMPONENT);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.RELIEF_COMPONENT;
	}
