...
public class DBRoom implements Importer {
	...
	public DBRoom(Connection batchConn, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {		
		...
		thematicSurfaceImporter = (ThematicSurface)dbImporterManager.getDBImporter(ImporterEnum.THEMATIC_SURFACE);
		buildingFurnitureImporter = (DBBuildingFurniture)dbImporterManager.getDBImporter(ImporterEnum.BUILDING_FURNITURE);
		buildingInstallationImporter = (DBBuildingInstallation)dbImporterManager.getDBImporter(ImporterEnum.BUILDING_INSTALLATION);
	}
	...
	public long insert(Room room, long buildingId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.ROOM);
