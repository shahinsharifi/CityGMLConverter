...
public class DBAppearance implements Importer {
	...
	private SurfaceData surfaceDataImporter;

	private boolean replaceGmlId;
	private int batchCounter;

	public DBAppearance(Connection batchConn, Config config, ImporterManager dbImporterManager) throws SQLException {
	...
	private void init() throws SQLException {
		...
		surfaceDataImporter = (SurfaceData)dbImporterManager.getDBImporter(ImporterEnum.SURFACE_DATA);
	}
	...
	private boolean insert(Appearance appearance, long appearanceId, CityGMLClass parent, long parentId) throws SQLException {
		...
		if (++batchCounter == Internal.POSTGRESQL_MAX_BATCH_SIZE)
			dbImporterManager.executeBatch(ImporterEnum.APPEARANCE);
	...
	public ImporterEnum getDBImporterType() {
		return ImporterEnum.APPEARANCE;
	}
