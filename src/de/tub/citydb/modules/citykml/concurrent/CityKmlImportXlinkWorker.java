...
public class CityKmlImportXlinkWorker implements Worker<DBXlink> {
	...
	public CityKmlImportXlinkWorker(CacheManager cacheManager, Config config, EventDispatcher eventDispatcher) {
		this.config = config;
