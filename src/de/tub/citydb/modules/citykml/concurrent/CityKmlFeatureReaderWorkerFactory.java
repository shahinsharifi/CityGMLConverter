...
public class CityKmlFeatureReaderWorkerFactory implements WorkerFactory<CityGMLChunk> {
	private final WorkerPool<CityGML> dbWorkerPool;
	private final Config config;
	private final EventDispatcher eventDispatcher;

	public CityKmlFeatureReaderWorkerFactory(WorkerPool<CityGML> dbWorkerPool,
			Config config,
	...
	public Worker<CityGMLChunk> createWorker() {
		return new CityKmlFeatureReaderWorker(dbWorkerPool, config, eventDispatcher);
	}
}
