...
public class CityKmlImportXlinkResolverWorkerFactory implements WorkerFactory<DBXlink> {
	...
	public CityKmlImportXlinkResolverWorkerFactory(DatabaseConnectionPool dbPool, 
	...
	public Worker<DBXlink> createWorker() {
		CityKmlImportXlinkResolverWorker dbWorker = null;

		try {
			dbWorker = new CityKmlImportXlinkResolverWorker(dbPool, 
					tmpXlinkPool, 
					lookupServerManager, 
					cacheManager, 
					importFilter,
