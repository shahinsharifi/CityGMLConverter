...
*/
	...
	private ColladaOptions getConfigColladaOptions() {
		return config.getProject().getCityKmlExporter().getGenericCityObjectColladaOptions();
	}

	private List<DisplayForm> getConfigDisplayForms() {
		return config.getProject().getCityKmlExporter().getGenericCityObjectDisplayForms();
	}

	private void setConfigDisplayForms(List<DisplayForm> displayForms) {
		config.getProject().getCityKmlExporter().setGenericCityObjectDisplayForms(displayForms);
	}
